...
const ShorthandRequestMethods = () => {
  ...
  async function fetchData() {
    let res = await axios.get(
      "https://6a02eca20d92f63dd25481e9.mockapi.io/api/details/users",
    );
  ...
  async function editData(formData) {
    ...
    const res = await axios.put(
      `https://6a02eca20d92f63dd25481e9.mockapi.io/api/details/users/${formData.id}`,
      formDetails,
    );
  ...
  async function DeleteData(id) {
    const res = await axios.delete(
      `https://6a02eca20d92f63dd25481e9.mockapi.io/api/details/users/${id}`,
    );
...
export default ShorthandRequestMethods;
