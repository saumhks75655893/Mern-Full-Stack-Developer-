...
async function weatherDetails() {
  ...
  img.src = JsonResult["current"].condition.icon;
  ...
  newDiv.innerHTML = `
      ...
      <div class="weatherDetails">
        ...
        <h3>Last Updated : <span class="localtime">${JsonResult["current"].last_updated}</span></h3>
        ...
        <h3>Condition : <span class="tz_id">${JsonResult["current"].condition.text}</span></h3>
      </div>
  `;
