...
// div.classList.add("bita");
// console.log(div.classList);
// div.classList.remove("bita");
// console.log(div.classList);
// // div.toggle("bita"); // toggle is not working
// // console.log(div.classList);
// let isAvaialble = div.classList.contains("bita");
...
// frstBtn.onclick = () => {
//   console.log("I'm the clicked of property method");
// };
// frstBtn.onclick = () => {
